...
BOT_NAME = "metalarchivescom"

SPIDER_MODULES = ["metalarchivescom.spiders"]
NEWSPIDER_MODULE = "metalarchivescom.spiders"
...
SPIDERMON_SPIDER_OPEN_MONITORS = {
    "metalarchivescom.monitors.SpiderOpenMonitorSuite",
}
SPIDERMON_SPIDER_CLOSE_MONITORS = {
    "metalarchivescom.monitors.SpiderCloseMonitorSuite",
}
SPIDERMON_PERIODIC_MONITORS = {
    "metalarchivescom.monitors.PeriodicMonitorSuite": 3600,  # time in seconds
}
